...
var app = (function () {
    ...
    /* src/Nested.svelte generated by Svelte v3.35.0 */
    ...
    function create_fragment(ctx) {
    	...
    	let t3;
    	let t4;
    	let t5_value = (/*count*/ ctx[0] === 0 ? "time" : "times") + "";
    	let t5;
    	let t6;
    	let nested;
    	let current;
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(p, "class", "svelte-urs9w7");
    			add_location(p, file, 18, 0, 221);
    			add_location(button, file, 19, 0, 241);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if ((!current || dirty & /*count*/ 1) && t5_value !== (t5_value = (/*count*/ ctx[0] === 0 ? "time" : "times") + "")) set_data_dev(t5, t5_value);
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Nested, count, handleClick });
